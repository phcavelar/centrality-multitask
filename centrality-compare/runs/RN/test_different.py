...
import pprint, os, sys, model, random, util, time, metrics
...
if __name__ == "__main__":
  ...
  test_instance_loader = InstanceLoader("./test-instances-different", rng = test_instance_loader_random_generator )

  test_logging_file = open( "./test-instances-different-{fname}.log".format( fname = fname ), "w" )
